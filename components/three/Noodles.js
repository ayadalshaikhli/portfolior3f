...
// const colorB = new THREE.Color('#000').convertSRGBToLinear()
// const fresnel = new THREE.Color('#fff').convertSRGBToLinear()
...
//     new Noise({ mapping: 'local', type: 'simplex', scale: 1000, colorA: '#fff', colorB: 'black', mode: 'overlay' })
//   ]
// })

// function Noodle() {
//   // Using useFrame on mouce move to change the material
...
//     material.layers[1].colorB.setHSL(mouse.x * 0.5 + 0.5, 0.5, 0.5)
//     material.layers[4].intensity = 0.3 + mouse.x * 0.7
//     material.layers[4].power = 2.5 + mouse.x * 2.5
//     material.layers[4].bias = 0.0 + mouse.x * 0.5
